...
async sttFromMic() {
    ...
    recognizer.recognizeOnceAsync(result => {
        ...
        if (result.reason === ResultReason.RecognizedSpeech) {
            ...
            displayText = 'ERROR: LA DETECCION HA SIDO CANCELADA . REVISA SI TU MICROFONO FUNCIONA BIEN';
        }
...
async fileChange(event) {
    ...
    recognizer.recognizeOnceAsync(result => {
        ...
        if (result.reason === ResultReason.RecognizedSpeech) {
            ...
            displayText = 'ERROR: LA DETECCION DE VOZ HA SIDO CANCELADA. REVISA SI TU MICROFONO ESTA ACTIVO';
        }
